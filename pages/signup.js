...
function Login() {
    ...
    const createProfile = async (token) => {
        setLoading(true)
        const data = await createUser(process.env.BACKEND + "/user/create/", { ...user, captcha: token })
    ...
    const handleSubmit = async (e) => {
        ...
        if (pass.pass1 !== pass.pass2) {
            ...
            window.grecaptcha.ready(function () {
                window.grecaptcha.execute("6LcW5B4hAAAAANaGdF-wliFOQg2JHTKxhYUvj7OW",
                ).then((token) => {
                    createProfile(token);
                })
            })
    ...
    return (
        <div className="h-screen">
            <Script src="https://www.google.com/recaptcha/api.js?render=6LcW5B4hAAAAANaGdF-wliFOQg2JHTKxhYUvj7OW" strategy='lazyOnload'></Script>
            <Head>
                <title>Signup | Aakhyaan Academy</title>
                <meta
                    name="description"
                    content="Sign up for Aakhyaan Academy and be a member to have full access to our contents."
                />
                <meta name="keywords" content="Sign up" />
                <meta property="og:title" content="Signup | Aakhyaan Academy" key="ogtitle" />
                <meta property="og:description" content="Sign up for Aakhyaan Academy and be a member to have full access to our contents." key="ogdesc" />
                    ...
                    <div className="animate-jumpLeft w-full max-w-xs md:max-w-sm flex flex-col gap-10">
                        <div>
                            <form className={`dark:md:bg-formBox md:bg-blue-200 md:shadow-md rounded px-5 md:px-12 pb-8 mb-4`} onSubmit={handleSubmit}>
                                <div className="dark:hidden float-right select-none w-full h-[100px] mb-10 mt-5 relative">
                                    <Image objectFit="contain" layout="fill" alt="Aakhyaan Academy" src="/aakhyaanText.png" priority="eager"></Image>
                                </div>
                                <div className="hidden dark:flex float-right select-none w-full h-[100px] mb-10 mt-5 relative">
                                ...
                                {!verification ?
                                    <div className="clear-both">
                                        ...
                                        <div className={`mb-4 font-sans tracking-wide text-center text-red-500`}>
                                            ...
                                            <input type="hidden" id="g-recaptcha-response" name="g-recaptcha-response"></input>      </div>
