...
function Login() {
    ...
    return (
        <div className="h-screen">
            <Head>
                <title>Login | Aakhyaan Academy</title>
                <meta
                    name="description"
                    content="Login to enjoy all the registered contents we provide."
                />
                <meta name="keywords" content="Login" />
                <meta property="og:title" content="Login | Aakhyaan Academy" key="ogtitle" />
                <meta property="og:description" content="Login to enjoy all the registered contents we provide." key="ogdesc" />
            </Head>
            <Header page="login" />
            {logged ? (
                <div
                ...
                >
                    ...
                    <div className="animate-jump w-full max-w-xs md:max-w-md flex flex-col gap-10 items-center">
                        <div>
                            ...
                            >
                                <div className="dark:hidden float-right select-none w-full h-[90px] mb-10 mt-5 relative">
                                    <Image objectFit="contain" layout="fill" alt="Aakhyaan Academy" src="/aakhyaanText.png" priority="eager"></Image>
                                </div>
                                <div className="hidden dark:flex float-right select-none w-full h-[90px] mb-10 mt-5 relative">
